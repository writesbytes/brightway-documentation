...
extensions = [
    ...
    # custom 404 page
    'notfound.extension',
    # Jupyter Notebook gallery support
...
path_dir_examples_gallery: list = ['../examples_gallery']
path_dir_auto_gallery_dir: list = ['autogenerated_examples_gallery']

sphinx_gallery_conf = {
    'examples_dirs': path_dir_examples_gallery,
    'gallery_dirs': path_dir_auto_gallery_dir,
